...
The annual report uses U.S. Letter portrait pages with equal 0.65-inch left and right margins so either single- or double-sided pages can be placed in a three-ring binder. Services print oldest to newest within each year. On the same date, Lehr services print before Gebets, while records of the same type retain their entry order. All Years prints the oldest year first, and every year begins on the next available printed page without inserting a blank sheet. Each page repeats the Lehr Register title, year, that year's service count, and Continued on later pages. Page numbering restarts for each year, and every footer includes the print date.
